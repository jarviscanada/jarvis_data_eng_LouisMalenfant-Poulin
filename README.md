...
**Proficient:** Python, Java, Linux/Bash, RDBMS/SQL, Agile/Scrum, Git, Pandas/Numpy

**Competent:** C/C++, React, Haskell, Docker, Machine learning

**Familiar:** Burpsuit, Wireshark, Pentesting tools, Javascript, Flask
