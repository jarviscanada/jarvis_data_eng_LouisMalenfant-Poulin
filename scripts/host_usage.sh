...
insert_statement="INSERT INTO host_usage ('timestamp', host_id, memory_free, cpu_idle, cpu_kernel, disk_io, disk_available) VALUES($timestamp, 4, $memory_free, $cpu_idle, $cpu_kernel, $disk_io, $disk_available);"
